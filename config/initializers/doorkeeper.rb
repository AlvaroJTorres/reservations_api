...
Doorkeeper.configure do
  ...
  resource_owner_from_assertion do
    ...
    when 'facebook'
      result = Operations::UserOperations::FacebookAuthenticate.call(params: params)
    when 'google'
      result = Operations::UserOperations::GoogleAuthenticate.call(params: params)
    end
  ...
  optional_scopes :admin, :manager, :customer
